  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      try {
        ...
        // 6. Build recent activities list
        const activities = [];
  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-6 py-8 items-center justify-center min-h-[50vh]">
        ...
        <p className="text-xs font-bold text-slate-400">Loading analytics dashboards...</p>
      </div>
    );
  }

  // Cards display config
  const cards = [
